...
use app\common\model\ShopBrand as Brand;
 ...
 * @title 产品品牌
 */
class Shopbrand extends Controller
{
    use HasIAED;
    use HasAutopost;
    ...
    protected function buildForm($isEdit, &$data = [])
    {
        ...
        $form->radio('type', '类型')->default(1)->options([1 => '不限', 2 => '目录', 3 => '品牌'])->required()->help('目录有下级，不能存产品。品牌无下级，只能存产品');
